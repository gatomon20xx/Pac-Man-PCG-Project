            ...
            */
            ...
            while (true)
            {
                ...
                if (turn) {
                    ...
                    if (dir.Item1 == 0) {
                        point.Item1 = point.Item1;
                        point.Item2 = lastPoint.Item2;
                    }
                    else {
                        point.Item1 = lastPoint.Item1;
                ...
                turn = false;
                turnAround = false;
                if (edges.ContainsKey(toIndex(tx+dir.Item2, ty-dir.Item1))) { // turn left
                    dirEnum = (dirEnum+3)%4;
                    turn = true;
                }
                else if (edges.ContainsKey(toIndex(tx+dir.Item1, ty+dir.Item2))) { // continue straight
                }
                else if (edges.ContainsKey(toIndex(tx-dir.Item2, ty+dir.Item1))) { // turn right
                    dirEnum = (dirEnum+1)%4;
                    turn = true;
                }
                else { // turn around
